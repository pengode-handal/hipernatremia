export const filters = [
  {
    key: "status",
    label: "Status",
    options: ["Semua Status", "Risiko Rendah", "Risiko Sedang", "Risiko Tinggi"],
  },
  {
    key: "age",
    label: "Umur",
    options: ["Semua Umur", "0-12 tahun", "13-18 tahun", "19-59 tahun", "60+ tahun"],
  },
  {
    key: "weight",
    label: "Berat Badan",
  ...
  },
  {
    key: "height",
    label: "Tinggi Badan",
    options: ["Semua TB", "0-140 cm", "141-160 cm", "161-180 cm", "181+ cm"],
  },
  {
    key: "risk",
    label: "Risiko Meter",
